 ...
 * */
class NotStudentInviteHostFragment : FormFragment() {

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle? ): View? {

        // É preciso inflar o layout que vai conter os fragmentos.
        val view = inflater.inflate(R.layout.fragment_invite_not_student_host, container, false)
        ...
        if( savedInstanceState == null ){
             ...
             * */
            transaction
                .replace(R.id.fl_root_not_student, NotStudentInviteFragment())
                .commit()
        }
        return view
    }
