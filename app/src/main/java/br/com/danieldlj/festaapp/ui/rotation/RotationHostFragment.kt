 ...
 * */
class RotationHostFragment : FormFragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle? ): View? {
        ...
        if( savedInstanceState == null ){
             ...
             * */
            transaction
                .replace(R.id.fl_root, RotationFragment())
                .commit()
        }
        return view
    }
    ...
    override fun onResume() {
        super.onResume()
        (activity as MainActivity).updateToolbarTitleInFragment( R.string.title_frag_rotation )
    }
}