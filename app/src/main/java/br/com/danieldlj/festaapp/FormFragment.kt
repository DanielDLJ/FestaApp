...
abstract class FormFragment : Fragment(), TextView.OnEditorActionListener {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle? ): View? {
        ...
        val viewContainer = inflater
            .inflate(R.layout.fragment_form, container, false) as ViewGroup
    ...
    protected fun snackBarFeedback(
        ...
        val img = ResourcesCompat
            .getDrawable(resources, iconResource, null)
        img!!.setBounds(0, 0, img.intrinsicWidth, img.intrinsicHeight)

        val iconColor =
            if( status )
                ContextCompat
                    .getColor(activity!!, R.color.colorNavButton)
            else
                Color.RED
        ...
        spannedText.setSpan(
            ImageSpan( img, ImageSpan.ALIGN_BOTTOM ), 0, 1, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE)
    ...
    fun callPasswordDialog(){
        ...
        builder
            ...
            .setNegativeButton(R.string.dialog_password_cancel, { dialog, id -> dialog.cancel() })
            .setCancelable( false )
