 ...
 * */
class StudentInviteHostFragment : FormFragment() {

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle? ): View? {

        // É preciso inflar o layout que vai conter os fragmentos.
        val view = inflater.inflate(R.layout.fragment_invite_student_host, container, false)
        ...
        if( savedInstanceState == null ){
             ...
             * */
            transaction
                .replace(R.id.fl_root_student, StudentInviteFragment())
                .commit()
        }
        return view
    }
